...
/// <summary>
/// CustomTileView item component.
/// </summary>
public class CustomTileViewComponent : ListViewItem, IViewData<CustomTileViewItemDescription>,IBeginDragHandler
{
    /// <summary>
    ...
    {
        Debug.Log("eventData" + eventData.pointerEnter.name);
        base.OnPointerDown(eventData);
        if (Tiles.OnPointerDownAction != null)
        {
            Tiles.OnPointerDownAction(this);
        }
    }
}